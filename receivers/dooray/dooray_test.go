...
func TestNotify(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			expMsg:      "{\"botName\":\"{{ template \\\"default.title\\\" . }}\",\"botIconImage\":\"http://localhost/favicon.ico\",\"text\":\"[FIRING:1]  (val1)\\nhttp:/localhost/alerting/list\\n\\n**Firing**\\n\\nValue: [no value]\\nLabels:\\n - alertname = alert1\\n - lbl1 = val1\\nAnnotations:\\n - ann1 = annv1\\nSilence: http://localhost/alerting/silence/new?alertmanager=grafana\\u0026matcher=alertname%3Dalert1\\u0026matcher=lbl1%3Dval1\\nDashboard: http://localhost/d/abcd\\nPanel: http://localhost/d/abcd?viewPanel=efgh\\n\"}",
			expMsgError: nil,
		}, {
			...
			expMsg:      "{\"botName\":\"{{ template \\\"default.title\\\" . }}\",\"botIconImage\":\"http://localhost/favicon.ico\",\"text\":\"[FIRING:2]  \\nhttp:/localhost/alerting/list\\n\\n**Firing**\\n\\nValue: [no value]\\nLabels:\\n - alertname = alert1\\n - lbl1 = val1\\nAnnotations:\\n - ann1 = annv1\\nSilence: http://localhost/alerting/silence/new?alertmanager=grafana\\u0026matcher=alertname%3Dalert1\\u0026matcher=lbl1%3Dval1\\n\\nValue: [no value]\\nLabels:\\n - alertname = alert1\\n - lbl1 = val2\\nAnnotations:\\n - ann1 = annv2\\nSilence: http://localhost/alerting/silence/new?alertmanager=grafana\\u0026matcher=alertname%3Dalert1\\u0026matcher=lbl1%3Dval2\\n\"}",
			expMsgError: nil,
		}, {
			...
			expMsg:      "{\"botName\":\"customTitle {{ .Alerts.Firing | len }}\",\"botIconImage\":\"http://localhost/favicon.ico\",\"text\":\"customTitle 1\\nhttp:/localhost/alerting/list\\n\\ncustomDescription\"}",
			expMsgError: nil,
		},
	}
